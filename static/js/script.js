	...
	$(document).ready(function(){
		...
		var picArr = [
			...
			new pic({
				...
				img : { src : 'img/galery_small/2.png', offsetTop : 30, offsetLeft: 46}
			}),
			new pic({
			...
			new pic({
				...
				img : { src : 'img/galery_small/4.png', offsetTop : 43, offsetLeft: 73}
			}),
			new pic({
				top : 52, left : 315, width : 58,height : 90, href:'#',
				img : { src : 'img/galery_small/5.png', offsetTop : 13, offsetLeft: 42}
			}),
			new pic({
			...
			new pic({
				...
				img : { src : 'img/galery_small/7.png', offsetTop : 37, offsetLeft: 9}
			}),
			new pic({
				top : 148, left : 406, width : 137,height : 74, href:'#',
				img : { src : 'img/galery_small/8.png', offsetTop : 19, offsetLeft: 56}
			}),
			new pic({
				top : 69, left : 394, width : 75,height : 63, href:'#',
				img : { src : 'img/galery_small/9.png', offsetTop : 56, offsetLeft: 54}
			}),
			new pic({
				top : 30, left : 491, width : 62,height : 93, href:'#',
				img : { src : 'img/galery_small/10.png', offsetTop : 30, offsetLeft: 37}
			}),
			new pic({
				top : 72, left : 576, width : 64,height : 107, href:'#',
				img : { src : 'img/galery_small/6.png', offsetTop : 40, offsetLeft: 50}
			})
		];
